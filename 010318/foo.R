...
##    responses <- "no.transform"
    responses <- c("random", "random.class", "mean.feature", "no.transform", "no.transform.class", "model.mean.feature", responses[!(responses %in% c("mean.feature", "random", "no.transform", "model.mean.feature"))])
