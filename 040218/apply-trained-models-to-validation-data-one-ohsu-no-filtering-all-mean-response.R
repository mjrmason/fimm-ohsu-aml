...
rdata.file <- ".Rdata.validate.040218.one.ohsu.no.filtering.all.mean.response"

## A string that will be included in any output files.
file.prefix <- "fimm-ohsu-validate-trained-models-040218-one-ohsu-no-filtering-all-mean-response"
...
for(i in 1:length(exprs)) {
  ...
  orig.exprs[[ds]] <- orig.exprs[[ds]][common.genes, ]
}
