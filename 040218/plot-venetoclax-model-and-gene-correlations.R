...
## g <- plot.correlation(drug.pred.actual$actual, drug.pred.actual$predicted, display.pval = TRUE, size = 6, colour = "blue")
...
g <- plot.correlation(drug.resp, drug.pred.actual$predicted, display.pval = TRUE, size = 6, colour = "blue")
