...
## fimm.drugs <- c("FIMM100365", "FIMM003751")
## fimm.drugs <- c("FIMM003751")
## fimm.drugs <- c(fimm.drugs, "FIMM003708", "FIMM003750", "FIMM133840")
sub <- subset(fimm.dss.t0, (gof.l4 > 0.5) & (b.l4 < 0))
fimm.lst <- loocv.elastic.net.fimm(sub, fimm.expr, fimm.drugs, response.col = "auc.l4", alphas = c(0,1))
...
fimm.pp <- post.process.fits(fimm.lst, "fimm-loocv-")
...
ohsu.lst <- loocv.elastic.net.ohsu(sub, ohsu.expr, ohsu.rnaseq.sample.summary, ohsu.drugs, response.col = "auc.l4", alphas = c(0,1))
