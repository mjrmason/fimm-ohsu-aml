...
cat("Fit FIMM drug response data using L.4 and LL.4\n")
...
parentId <- "syn8270577"
executed.url <- "https://github.com/bswhite/fimm-ohsu-aml/blob/master/091117/fit-ohsu-and-fimm-drug-response-data.R"
