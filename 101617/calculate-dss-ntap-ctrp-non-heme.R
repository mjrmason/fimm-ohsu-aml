...
## Here "nc-non-heme" refers to "ntap-ctrp-non-heme", since we limit to non-heme ctrp samples
fit.file.prefix <- "nc-non-heme"
...
cl.subset <- subset(ctrp.cell.line.metadata, ccle_primary_site != "haematopoietic_and_lymphoid_tissue")
