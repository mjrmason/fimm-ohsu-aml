...
## Here "nc-skin" refers to "ntap-ctrp-skin", since we limit to ctrp skin samples
fit.file.prefix <- "nc-skin"
...
cl.subset <- subset(ctrp.cell.line.metadata, ccle_primary_site == "skin")
