...
data.set.dss.fit.synIds <- c("syn11291344", "syn11291345", "syn11291346", "syn11291347")
names(data.set.dss.fit.synIds) <- data.sets
data.set.dss.fit.files <- c("ohsu-foc-aml-s-aml-dss-t0.tsv", "ctrp-foc-aml-s-aml-dss-t0.tsv", "sanger-foc-aml-s-aml-dss-t0.tsv", "fimm-foc-aml-s-aml-dss-t0.tsv")

## Batch-corrected log2 cpm (or rma) expression files
data.set.expr.synIds <- c("syn11289074", "syn11289070", "syn11289071", "syn11289072")
names(data.set.expr.synIds) <- data.sets
data.set.expr.files <- c("ohsu-expr-foc-aml-s-aml-combat.tsv", "ctrp-expr-foc-aml-s-aml-combat.tsv", "sanger-expr-foc-aml-s-aml-combat.tsv", "fimm-expr-foc-aml-s-aml-combat.tsv")
