...
## Purpose:
## This file models 4 data sets (OHSU, FIMM, and the AML-subsets of Sanger and CTRP) based on expression data.
...
## calculate-dss-fimm-ohsu-ctrp-aml-sanger-aml.R
...
## These files may be created by a script such as
## normalize-fimm-ohsu-ctrp-aml-sanger-aml-expression-distributions.R
...
file.prefix <- "foc-aml-s-aml-outlier-ds"
