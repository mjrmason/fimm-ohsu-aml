...
rdata.file <- ".Rdata.validate.112217.one.ohsu.no.filtering.mean.response"
...
file.prefix <- "fimm-ohsu-validate-trained-models-112217-one-ohsu-no-filtering-mean-response"
...
if(do.downsampling) {
  ...
  cat("Including mean response as a feature\n")
